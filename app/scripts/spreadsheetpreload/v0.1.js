  ...
  "upgrades": {
    ...
    "elements": [
      ...
      },
      {
        ...
        "cost.unittype": "meat",
        "cost.val": 7000,
        "description": "Use meat to instantly create {{upgrade.type.effect[1].val | longnum}} larvae and clone your existing {{ game.unit('larva').count() + game.unit('cocoon').count() | longnum }} larvae and cocoons.",
        "effect.stat": "",
