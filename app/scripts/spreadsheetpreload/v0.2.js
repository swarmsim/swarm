  ...
  "unittypes": {
    ...
    "elements": [
      ...
      },
      {
        ...
        "cost.unittype": "larva",
        "cost.val": 1,
        "description": "<p>Each cocoon is a larva encased within a protective shell. Larvae can freely enter and leave their cocoons, but cannot be transformed into other units while cocooned.</p><p>Clone Larvae clones cocoons as if they were normal larvae. Cocoon your larvae intended for cloning to avoid accidentally spending them.</p>",
        "disabled": "",
        "effect.stat": "",
        "effect.type": "",
        "effect.unittype": "",
      ...
      },
      {
        ...
        "cost.unittype": "",
        "cost.val": "",
        "description": "starting mutagen each ascension",
        "disabled": "TRUE",
        "effect.stat": "",
        "effect.type": "",
        "effect.unittype": "",
      ...
      },
      {
        ...
        "cost.val": 100000000000000000000,
        "description": "",
        "disabled": "",
        "effect.stat": "",
        "effect.type": "",
      ...
      },
      {
        ...
        "name": "pantheon7",
        "plural": "pantheons^7",
        "prod.unittype": "pantheon6",
        "prod.val": 16,
        "requires.unittype": "pantheon6",
        "requires.upgradetype": "",
        "requires.val": 1,
        "rowNumber": 55,
        "showparent": "",
      ...
      },
      {
        ...
        "name": "pantheon8",
        "plural": "pantheons^8",
        "prod.unittype": "pantheon7",
        "prod.val": 17,
        "requires.unittype": "pantheon7",
        "requires.upgradetype": "",
        "requires.val": 1,
        "rowNumber": 58,
        "showparent": "",
      ...
      },
      {
        ...
        "cost.val": 10,
        "description": "<p>Nightbugs wriggle and glow when exposed to the energy of your nexus. Gather nightbugs near your nexus to store additional energy.</p><p>Your nightbugs store up to {{(unit.effect[0].calcStats().capMult - 1) * 100 | number:2}}% more maximum energy. Hatching more can increase this to a maximum of {{(unit.effect[0].val - 1) * 100 | number:0}}%.</p>",
        "disabled": "",
        "effect.stat": "capMult",
      ...
      },
      {
        ...
        "cost.unittype": "moth",
        "cost.val": 10,
        "description": "<p>Bats feed on your lepidoptera, but empower all of your swarm's energy-based abilities.</p><p>Your bats make your abilities {{(unit.effect[0].calcStats().power - 1) * 100 | number:2}}% more powerful. Raising more can increase this to a maximum of {{(unit.effect[0].val - 1) * 100 | number:0}}%.</p>",
        "disabled": "",
        "effect.stat": "power",
        "effect.type": "asympStat",
        "effect.unittype": "energy",
    ...
    "elements": [
      {
        ...
        "cost.unittype": "meat",
        "cost.val": 300,
        "description": "Each hatchery produces {{upgrade.type.effect[0].val | number}} more larva per second. Currently, your hatcheries produce {{upgrade.unit.prod[0].val + upgrade.effect[0].calcStats().base | number:0}} larvae.",
        "effect.stat": "base",
        "effect.type": "addStat",
      ...
      },
      {
        ...
        "cost.val": 10,
        "description": "Each expansion increases your hatcheries' larvae production by {{(upgrade.type.effect[0].val - 1) * 100 | number:0}}%. Currently, your expansions increase larvae production by {{(upgrade.effect[0].calcStats().prod - 1) * 100 | number:0}}%.",
        "effect.stat": "prod",
      ...
      },
      {
        ...
        "effect.val": 2,
        "effect.val2": "",
        "label": "faster pantheons of pantheons",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon3",
        "cost.val": 66,
        "description": "Pantheons^3 produce more pantheons of pantheons.",
        "effect.stat": "prod",
        "effect.type": "multStat",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon4",
        "cost.val": 66,
        "description": "Pantheons^4 produce more pantheons^3.",
        "effect.stat": "prod",
        "effect.type": "multStat",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon5",
        "cost.val": 66,
        "description": "Pantheons^5 produce more pantheons^4.",
        "effect.stat": "prod",
        "effect.type": "multStat",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon6",
        "cost.val": 66,
        "description": "Pantheons^6 produce more pantheons^5.",
        "effect.stat": "prod",
        "effect.type": "multStat",
        "effect.unittype": "pantheon6",
        "effect.unittype2": "",
        "effect.val": 2,
        "effect.val2": "",
        "label": "faster pantheons^6",
        "lol": "",
        "maxlevel": "",
        "name": "pantheon6prod",
        "requires.unittype": "pantheon6",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon7",
        "cost.val": 66,
        "description": "Pantheons^7 produce more pantheons^6.",
        "effect.stat": "prod",
        "effect.type": "multStat",
        "effect.unittype": "pantheon7",
        "effect.unittype2": "",
        "effect.val": 2,
        "effect.val2": "",
        "label": "faster pantheons^7",
        "lol": "",
        "maxlevel": "",
        "name": "pantheon7prod",
        "requires.unittype": "pantheon7",
      ...
      },
      {
        "class": "upgrade",
        "cost.factor": 666,
        "cost.unittype": "pantheon8",
        "cost.val": 66,
        "description": "Pantheons^8 produce more pantheons^7.",
        "effect.stat": "prod",
        "effect.type": "multStat",
        "effect.unittype": "pantheon8",
        "effect.unittype2": "",
        "effect.val": 2,
        "effect.val2": "",
        "label": "faster pantheons^8",
        "lol": "",
        "maxlevel": "",
        "name": "pantheon8prod",
        "requires.unittype": "pantheon8",
        "requires.val": 67,
        "rowNumber": 22,
        "unittype": "pantheon8"
      },
      ...
      },
      {
        ...
        "cost.unittype": "empress",
        "cost.val": 1,
        "description": "Multiple hive queens are constructed from each larva. (This does not affect hive empress production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "hivequeen",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "prophet",
        "cost.val": 1,
        "description": "Multiple hive empresses hatch from each larva. (This does not affect hive prophet production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "empress",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "goddess",
        "cost.val": 1,
        "description": "Multiple hive prophets hatch from each larva. (This does not affect goddess of the hive production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "prophet",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon",
        "cost.val": 1,
        "description": "Multiple goddesses of the hive are summoned by each larva. (This does not affect brood pantheon production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "goddess",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon2",
        "cost.val": 1,
        "description": "Multiple brood pantheons are created from each larva. (This does not affect pantheon of pantheons production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "pantheon",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon3",
        "cost.val": 1,
        "description": "Multiple pantheons of pantheons are created from each larva. (This does not affect pantheon^3 production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "pantheon2",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon4",
        "cost.val": 1,
        "description": "Multiple pantheons^3 are created from each larva. (This does not affect pantheon^4 production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "pantheon3",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon5",
        "cost.val": 1,
        "description": "Multiple pantheons^4 are created from each larva. (This does not affect pantheon^5 production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "pantheon4",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon6",
        "cost.val": 1,
        "description": "Multiple pantheons^5 are created from each larva. (This does not affect pantheon^6 production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "pantheon5",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon7",
        "cost.val": 1,
        "description": "Multiple pantheons^6 are created from each larva. (This does not affect pantheon^7 production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "pantheon6",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "pantheon8",
        "cost.val": 1,
        "description": "Multiple pantheons^7 are created from each larva. (This does not affect pantheon^8 production.)",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "pantheon7",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "",
        "cost.val": "",
        "description": "Multiple pantheons^8 are created from each larva.",
        "effect.stat": "",
        "effect.type": "",
        "effect.unittype": "",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "energy",
        "cost.val": 4200,
        "description": "Warp time around your swarm. Instantly travel {{ upgrade.effect[0].output() / 60 | longnum }} minutes into the future, gaining {{ upgrade.effect[0].output() / 60 | longnum }} minutes' worth of production. ",
        "effect.stat": "",
