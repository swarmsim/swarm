  ...
  "unittypes": {
    ...
    "elements": [
      ...
      },
      {
        ...
        "cost.val": 10,
        "description": "<p>Nightbugs wriggle and glow when exposed to the energy of your nexus. Gather nightbugs near your nexus to store additional energy.</p><p>Your nightbugs store up to {{(unit.effect[0].calcStats().capMult - 1) * 100 | number:2}}% more maximum energy.</p>",
        "disabled": "",
        "effect.stat": "capMult",
      ...
      },
      {
        ...
        "cost.unittype": "moth",
        "cost.val": 10,
        "description": "<p>Bats feed on your lepidoptera, but empower all of your swarm's energy-based abilities.</p><p>Your bats make your abilities {{(unit.effect[0].calcStats().power - 1) * 100 | number:2}}% more powerful.</p>",
        "disabled": "",
        "effect.stat": "power",
        "effect.type": "asympStat",
        "effect.unittype": "energy",
  ...
  "upgrades": {
    ...
    "elements": [
      ...
      },
      {
        ...
        "cost.unittype": "energy",
        "cost.val": 4200,
        "description": "Travel {{ upgrade.effect[0].output() / 60 | longnum }} minutes into the future, gaining {{ upgrade.effect[0].output() / 60 | longnum }} minutes' worth of production. <span ng-if=\"upgrade.effect[0].hasParentStat('power', 1)\">(&times;{{upgrade.effect[0].parentStat('power')|bignum:10}} bonus)</span>",
        "effect.stat": "",
