  ...
  "upgrades": {
    ...
    "elements": [
      ...
      },
      {
        ...
        "cost.unittype": "pantheon2",
        "cost.val": 1000000000000,
        "description": "Multiple pantheons of pantheons are created from each larva.",
        "effect.stat": "twin",
        "effect.type": "multStat",
        "effect.unittype": "pantheon2",
        "effect.unittype2": "",
      ...
      },
      {
        ...
        "cost.unittype": "energy",
        "cost.val": 1600,
        "description": "Instantly birth {{ upgrade.effect[0].output() + upgrade.effect[1].output() | longnum }} new larvae. <span ng-if=\"upgrade.effect[0].hasParentStat('power', 1)\">(&times;{{upgrade.effect[0].parentStat('power')|bignum:10}} bonus)</span>",
        "effect.stat": "",
      ...
      },
      {
        ...
        "cost.unittype": "energy",
        "cost.val": 4200,
        "description": "Warp time around your swarm. Instantly travel {{ upgrade.effect[0].output() / 60 | longnum }} minutes into the future, gaining {{ upgrade.effect[0].output() / 60 | longnum }} minutes' worth of production. <span ng-if=\"upgrade.effect[0].hasParentStat('power', 1)\">(&times;{{upgrade.effect[0].parentStat('power')|bignum:10}} bonus)</span>",
        "effect.stat": "",
      ...
      },
      {
        ...
        "cost.unittype": "energy",
        "cost.val": 1600,
        "description": "Instantly create {{ upgrade.effect[0].output() + upgrade.effect[1].output() | longnum }} new meat. <span ng-if=\"upgrade.effect[0].hasParentStat('power', 1)\">(&times;{{upgrade.effect[0].parentStat('power')|bignum:10}} bonus)</span>",
        "effect.stat": "",
        "effect.type": "addUnitByVelocity",
      ...
      },
      {
        ...
        "cost.unittype": "energy",
        "cost.val": 1600,
        "description": "Instantly capture {{ upgrade.effect[0].output() + upgrade.effect[1].output() | longnum }} new territory. <span ng-if=\"upgrade.effect[0].hasParentStat('power', 1)\">(&times;{{upgrade.effect[0].parentStat('power')|bignum:10}} bonus)</span>",
        "effect.stat": "",
        "effect.type": "addUnitByVelocity",
      ...
      },
      {
        ...
        "cost.unittype": "energy",
        "cost.val": 12000,
        "description": "<p>Clone {{ upgrade.effect[0].output() + upgrade.effect[1].output() | longnum }} new larvae.</p><p>You produce {{ game.unit('larva').velocity() | longnum }} larvae per second, allowing you to clone up to {{ upgrade.effect[0].cap() | longnum }} larvae<span ng-if=\"upgrade.effect[0].hasParentStat('power', 1)\"> (&times;{{upgrade.effect[0].parentStat('power')|bignum:10}} bonus)</span>. You have {{ upgrade.effect[0].bank() | longnum}} larvae and cocoons available to clone.</p>",
        "effect.stat": "",
        "effect.type": "compoundUnit",
        "effect.unittype": "larva",
      ...
      },
      {
        ...
        "cost.unittype": "energy",
        "cost.val": 1,
        "description": "For two minutes, all production is increased by {{ upgrade.effect[0].output() * 100|number:0}}%. <span ng-if=\"upgrade.effect[0].hasParentStat('power', 1)\">(&times;{{upgrade.effect[0].parentStat('power')|bignum:10}} bonus)</span>",
        "effect.stat": "",
