...
// import 'angular'
import '@bower_components/angular-animate';
import '@bower_components/angular-cookies';
import '@bower_components/angular-resource';
import '@bower_components/angular-route';
// import '@bower_components/angular-sanitize'
import '@bower_components/angular-touch';
import '@bower_components/angulartics';
import '@bower_components/angulartics-google-analytics';
// import '@bower_components/angular-google-chart'
...
import './spreadsheetpreload/v0.2.playfabUpload.main';

// angular-sanitize wants this, version woes
...
angular.module('swarmApp').constant('env', {
  // TODO make this injectable by env
  isOffline: false,
  name: 'dev',
  isDebugEnabled: true,
  isDebugLogged: true,
  ...
  spreadsheetKey: 'v0.2',
  saveId: 'v0.2',
  saveServerUrl: 'https://api-preprod.swarmsim.com',
...
angular.module('swarmApp').constant('version', version.version);
...
angular.module('swarmApp').run(function(hotkeys, $location) {
  ...
  return (() => {
    const result = [];
    for (var [combo, path, desc] of Array.from(locationKeys)) {       result.push((((combo, path, desc) => hotkeys.add({
      combo,
      description: desc,
