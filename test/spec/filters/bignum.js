...
describe('Filter: bignum', function() {
  ...
  it('should format numbers', function() {
    ...
    return expect(bignum(111111111111111111111111111111111111111)).toBe('111UDc');
  });
  ...
  it('should use other number formats', function() {
    ...
    return expect(longnum(123456789e30)).toBe('123.456E36');
  });

  it('should support Bignumbers', function() {
    ...
    return expect(bignum(new Decimal('1e+100000')) ).toBe('10.0E99999');
  });


  return it('rounds down, preventing things like "1.00e+3M", bug #245', function() {
    expect(bignum(1000000000)).toBe('1.00B');
    return expect(bignum(1000000000-1)).toBe('999M');
  });
});
